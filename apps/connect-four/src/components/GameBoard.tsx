...
function GameBoard(props: {
  ...
  return (
    <div class="flex w-full flex-col items-center">
      ...
      <div class="grid aspect-7/6 screen-35:w-game-board-35 screen-40:w-game-board-40 screen-45:w-game-board-45 screen-50:w-game-board-50 w-game-board min-w-80 max-w-full grid-cols-7 grid-rows-6 rounded-5 bg-board screen-35:p-1.5 screen-40:p-2.5 screen-45:p-3.5 screen-50:p-4.5">
